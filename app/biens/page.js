...
const data = await getBiensData("biens");
export default function PageBien () {
...
<main>
    <div className="bg-immo-secondary ">
        <div className="Header text-center ">
            <h1 className="font-bold text-4xl pt-32 pb-6">Tous nos biens immobiliers</h1>
            <p className="text-gray-400 pb-40">Découvrez notre catalogue complet de biens à la vente et à la location</p>
        </div>
      ...
      <div className="bg-immo-primary text-white">
              ...
              <p className="flex justify-center px-4 min-[426px]:px-0 pt-3 pb-12">
                Contactez-nous dès maintenant pour un accompagnement sur mesure.
              </p>
            ...
            />
            Ouvert du lundi au vendredi de 9h à 19h et le samedi de 9h à 17h. </p>
            </div>
</main>
